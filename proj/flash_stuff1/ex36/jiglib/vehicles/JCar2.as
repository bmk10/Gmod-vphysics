package jiglib.vehicles
{
	...
	public class JCar2
	{
		...
		private var _chassis:JChassis2;
		private var _wheels:Array;
		private var _steerWheels:Array;

		public function JCar2(skin:ISkin3D):void
		{
			_chassis = new JChassis2(this, skin);
			_wheels = [];
			_steerWheels = [];
			...
			wheelNumRays:int = 1):void
		{
			...
			_wheels[_name] = new JWheel2(this);
		...
		public function get chassis():JChassis2
		{
			return _chassis;
		}
		...
		{
			for each (var wheel:JWheel2 in wheels)
			{
		...
		public function postPhysics(dt:Number):void
		{
			...
			for each (var _steerWheel:JWheel2 in _steerWheels)
			{
