...
#ifndef CW_VEHICLES_H
#define CW_VEHICLES_H
#ifdef _WIN32
#pragma once
#endif
...
#define VEHICLE_TYPE_TANK_RAYCAST	(1<<4)
#define VEHICLE_TYPE_PLANE_RAYCAST	(1<<5)
#define VEHICLE_TYPE_HELICOPTER_RAYCAST	(1<<6)
#define VEHICLE_TYPE_MANTA_RAYCAST	(1<<7)
#define VEHICLE_TYPE_MECH_RAYCAST	(1<<8)


#define VEHICLE_MAX_AXLE_COUNT	20
#define VEHICLE_MAX_GEAR_COUNT	20
...
#define VEHICLE_TIRE_TREAD	3
#define VEHICLE_TIRE_FLAT	4
#define VEHICLE_TIRE_ONFIRE	5
#define VEHICLE_TIRE_DAMGED1	6
#define VEHICLE_TIRE_DAMGED2	7
#define VEHICLE_TIRE_DAMGED3	8
